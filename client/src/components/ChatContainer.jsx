  ...
  return selectedUser ? (
    <div className="h-full  overflow-auto relative backdrop-blur-lg border-r-2 border-slate-600">
      ...
      <div className="flex items-center gap-3 py-3 mx-4 border-b border-stone-500">
        ...
        <div className="flex  justify-between items-center w-full">
          ...
          <img
            ...
            alt="helop_icon"
            className="max-w-5 max-h-5 md:max-w-9"
          />
        </div>
      </div>
          ...
          message.map((msg, i) => (
            <div
              ...
              className={`flex items-end gap-2 justify-end ${
                msg.sender_id === selectedUser._id && "flex-row-reverse"
              }`}
            >
              {msg.img ? (
                <img
                  src={msg?.img}
                  alt="image"
                  className="w-38 my-5 rounded relative z-0"
                />
              ) : (
                <p
              ...
              <div className="text-center text-xs w-7 h-7 rounded-full overflow-hidden">
                <img
                  src={
                    msg.sender_id === selectedUser._id
                      ? selectedUser.picture || FALBACK_USER_IMAGE
                      : authUser.picture || FALBACK_USER_IMAGE
                  }
                  alt="avatar"
                  className="w-full"
                />
      ...
      <div className="flex items-center gap-1 max-w-[90%] m-auto mb-5 transform">
        ...
        <button onClick={messageSendHandler} type="submit">
          <img
