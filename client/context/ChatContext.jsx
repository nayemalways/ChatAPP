...
export const ChatProvider = ({ children }) => {
        ...
        socket.on("newMessage", (newMessage) => {
            if(selectedUser && newMessage.sender_id === selectedUser._id) {
                ...
                setUnseenMessage((prevUnseenMessage)=> ({
                    ...prevUnseenMessage, [newMessage.sender_id] : prevUnseenMessage[newMessage.sender_id] ? prevUnseenMessage[newMessage.sender_id] + 1 : 1
                }))
            }
        })
    }
    ...
    const value = {
        getUsers, users, getMessages, message, selectedUser,setMessage,
        sendMessage, setSelectedUser, unseenMessage, setUnseenMessage, loadSelectedMessage
    }
